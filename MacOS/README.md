...
Para la evidencia de esta virtualización habremos guardado todos los comando usados en el script en bash: ``cheetah.sh`` y ``chetah.ps1``, que se encuentra en el mismo directorio que este archivo. 
...
Aquí debemos de hacer click en __Installer__ arriba a la izquierda y seleccionar la opción __Open Disk Utility__ que nos ayudará a formatear el disco principal.
